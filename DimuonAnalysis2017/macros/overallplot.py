...
#legend.SetNDC()
for i in range(0,1):
	hist=file.Get("massOS_Inclusive")
...
#'L1_DoubleMu4p5er2p0_SQ_OS_Mass_Min7'
	...
	legend.AddEntry(hist  ,str(labels[i]),"lpe")
	hist.SetTitle("")
	hist.GetYaxis().SetRangeUser(1000.,10**12)
...
c2.RedrawAxis()
c2.Update()
c2.SaveAs("alltheL1new17Inclusive.root")
c2.SaveAs("alltheL1new17Inclusive.pdf")
