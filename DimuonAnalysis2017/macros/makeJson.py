...
#USAGE example: python makeJson.py  --tree 'mmtree/tree' --lumi-branch 'lumSec' --run-branch 'run' /eos/cms/store/user/jsalfeld/ScoutingCaloMuon/crab_20171116_014051/171116_004101/0000/ml9.root --out lumi1.txt
