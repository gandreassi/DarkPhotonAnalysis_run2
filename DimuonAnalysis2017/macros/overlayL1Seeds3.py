...
#nominal file=ROOT.TFile.Open("./L1_2017_all.root")
file=ROOT.TFile.Open("./allInclusL1.root")
...
legend = ROOT.TLegend(0.21,0.18,0.71,0.38)
...
for i in range(0,21):
	...
	if i<10:      
		...
		hist.SetLineColor(kRed-i+10+1)
		hist.SetMarkerColor(kRed-i+10+1)

	if names[i]=='L1_DoubleMu5_SQ_OS_Mass7to18':
	...
	hist.SetTitle("")
	hist.GetYaxis().SetRangeUser(100.,10**12)
...
cmsTag3=ROOT.TLatex(0.94,0.960,"#scale[0.9]{#bf{35 fb^{-1} (13 TeV, 2017)}}")
cmsTag3.SetNDC()
...
z0=ROOT.TLatex(0.875,0.56+a,"#scale[0.75]{#bf{Z}}")
z0.SetNDC()
z0.SetTextAlign(31)
#cmsTag.SetTextFont(61)
z0.Draw()
...
c2.RedrawAxis()
c2.Update()
c2.SaveAs("alltheL1new.root")
c2.SaveAs("alltheL1new.pdf")
