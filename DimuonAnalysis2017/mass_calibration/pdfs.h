...
class reso_pdfs {
	public:
		...
		reso_pdfs(){
			...
			//// common params
			RooRealVar alpha1  ("alpha1"  	, "alpha1 " 	, 1.,0.,2.);
			RooRealVar alpha2  ("alpha2"  	, "alpha2 " 	, 1.,0.,2.);
			RooRealVar n1  ("n1"  	, "n1 " 	, 3);//,0.5,5);
			RooRealVar n2  ("n2"  	, "n2 " 	, 3);//,0.5,5);
			//////
			...
			RooDoubleCB signalModel_CB_omega("signalModel_CB_omega"	, "signalModel_CB_omega", m2mu_omega,M_omega,res_CB_omega, alpha1,n1,alpha2,n2);
			RooFormulaVar res_gau_omega("res_gau_omega"  	, "0.5*M_omega*res_omega_rel" , RooArgList(M_omega, res_omega_rel));
			...
			RooDoubleCB signalModel_CB_phi("signalModel_CB_phi"	, "signalModel_CB_phi", m2mu_phi,M_phi,res_CB_phi, alpha1,n1,alpha2,n2);
			RooFormulaVar res_gau_phi("res_gau_phi"  	, "0.5*M_phi*res_phi_rel" , RooArgList(M_phi, res_phi_rel));
			...
			RooRealVar m2mu_jpsi  ("m2mu_jpsi"  	, "m2mu_jpsi" 	, 0,15);
			...
			RooDoubleCB signalModel_CB_jpsi("signalModel_CB_jpsi"	, "signalModel_CB_jpsi", m2mu_jpsi,M_jpsi,res_CB_jpsi, alpha1,n1,alpha2,n2);
			RooFormulaVar res_gau_jpsi("res_gau_jpsi"  	, "0.5*M_jpsi*res_jpsi_rel" , RooArgList(M_jpsi, res_jpsi_rel));
			RooGaussian signalModel_gau_jpsi("signalModel_gau_jpsi", "signalModel_gau_jpsi", m2mu_jpsi,M_jpsi,res_gau_jpsi);
			...
			RooRealVar sig_fraction_jpsi("sig_fraction_jpsi", "",0.5,0.02,0.99);
			RooRealVar par1_jpsi("par1_jpsi", "par1_jpsi", 0.2, 0, 10);
			RooRealVar par2_jpsi("par2_jpsi", "par2_jpsi", 1.5, 0, 10);
			RooRealVar par3_jpsi("par3_jpsi", "par3_jpsi", 2.0, 0, 10);
			RooRealVar par4_jpsi("par4_jpsi", "par4_jpsi", 2.0, 0, 10);
			RooArgList parlist_jpsi(par1_jpsi, par2_jpsi, par3_phi, par4_jpsi);
			RooBernstein bkgModel_jpsi("bkgModel_jpsi", "bkgModel_jpsi", m2mu_jpsi, parlist_jpsi);
			RooAddPdf model_jpsi("model_jpsi", "model_jpsi", RooArgList(signalModel_jpsi, bkgModel_jpsi), RooArgList(sig_fraction_jpsi));
			w->import(model_jpsi);
			...
			RooRealVar m2mu_psi2s  ("m2mu_psi2s"  	, "m2mu_psi2s" 	, 0,15);
			...
			RooDoubleCB signalModel_CB_psi2s("signalModel_CB_psi2s"	, "signalModel_CB_psi2s", m2mu_psi2s,M_psi2s,res_CB_psi2s, alpha1,n1,alpha2,n2);
			RooFormulaVar res_gau_psi2s("res_gau_psi2s"  	, "0.5*M_psi2s*res_psi2s_rel" , RooArgList(M_psi2s, res_psi2s_rel));
			RooGaussian signalModel_gau_psi2s("signalModel_gau_psi2s", "signalModel_gau_psi2s", m2mu_psi2s,M_psi2s,res_gau_psi2s);
			...
			RooRealVar sig_fraction_psi2s("sig_fraction_psi2s", "",0.5,0.02,0.99);
			RooRealVar par1_psi2s("par1_psi2s", "par1_psi2s", 0.2, 0, 10);
			RooRealVar par2_psi2s("par2_psi2s", "par2_psi2s", 1.5, 0, 10);
			RooRealVar par3_psi2s("par3_psi2s", "par3_psi2s", 2.0, 0, 10);
			RooRealVar par4_psi2s("par4_psi2s", "par4_psi2s", 2.0, 0, 10);
			RooArgList parlist_psi2s(par1_psi2s, par2_psi2s, par3_psi2s, par4_psi2s);
			RooBernstein bkgModel_psi2s("bkgModel_psi2s", "bkgModel_psi2s", m2mu_psi2s, parlist_psi2s);
			RooAddPdf model_psi2s("model_psi2s", "model_psi2s", RooArgList(signalModel_psi2s, bkgModel_psi2s), RooArgList(sig_fraction_psi2s));
			w->import(model_psi2s);
			...
			RooDoubleCB signalModel_CB_upsilon1s("signalModel_CB_upsilon1s"	, "signalModel_CB_upsilon1s", m2mu_upsilon,M_upsilon1s,res_CB_upsilon1s, alpha1,n1,alpha2,n2);
			RooFormulaVar res_gau_upsilon1s("res_gau_upsilon1s"  	, "0.5*M_upsilon1s*res_upsilon1s_rel" , RooArgList(M_upsilon1s, res_upsilon1s_rel));
			...
			RooDoubleCB signalModel_CB_upsilon2s("signalModel_CB_upsilon2s"	, "signalModel_CB_upsilon2s", m2mu_upsilon,M_upsilon2s,res_CB_upsilon2s, alpha1,n1,alpha2,n2);
			RooFormulaVar res_gau_upsilon2s("res_gau_upsilon2s"  	, "0.5*M_upsilon2s*res_upsilon2s_rel" , RooArgList(M_upsilon2s, res_upsilon2s_rel));
			...
			RooDoubleCB signalModel_CB_upsilon3s("signalModel_CB_upsilon3s"	, "signalModel_CB_upsilon3s", m2mu_upsilon,M_upsilon3s,res_CB_upsilon3s, alpha1,n1,alpha2,n2);
			RooFormulaVar res_gau_upsilon3s("res_gau_upsilon3s"  	, "0.5*M_upsilon3s*res_upsilon3s_rel" , RooArgList(M_upsilon3s, res_upsilon3s_rel));
